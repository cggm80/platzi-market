...
public class ProductController {
    ...
    public ResponseEntity<Product> getProduct(@ApiParam(value = "The ID of the product ", required = true, example = "7") @PathVariable("id") int idProducto) {
    ...
    public Optional<List<Product>> findByQuantityStockLessThanAndEstado(Integer quantity, boolean active) {
        return productService.findByQuantityStockLessThanAndEstado(quantity, active);
    }


    public List<Product> findByIdCategoryOrderByNameAsc(Integer idCategory) {
        return productService.findByIdCategoryOrderByNameAsc(idCategory);
    }
